...
@.str28 = private unnamed_addr constant [71 x i8] c"dev_run %s with (%dx%dx%d) blks, (%dx%dx%d) threads, %d shmem (t=%lld)\00", align 1
@.str29 = private unnamed_addr constant [23 x i8] c"get_kernel %s (t=%lld)\00", align 1
@.str30 = private unnamed_addr constant [5 x i8] c"size\00", align 1
...
if.end58:                                         ; preds = %if.end42, %if.end, %if.then50
  %8 = load %struct.CUmod_st** @_Z5__mod, align 8, !tbaa !1
  %tobool59 = icmp eq %struct.CUmod_st* %8, null
  br i1 %tobool59, label %do.body61, label %if.end74

do.body61:                                        ; preds = %if.end58
  %call62 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8]* @.str14, i64 0, i64 0))
...
if.then66:                                        ; preds = %do.body61
  %call67 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([35 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([17 x i8]* @.str14, i64 0, i64 0), i32 %call64)
  call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([23 x i8]* @.str6, i64 0, i64 0))
  br label %do.end72

do.end72:                                         ; preds = %do.body61, %if.then66
  %call73 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([36 x i8]* @.str15, i64 0, i64 0), i8* %ptx_src)
  br label %if.end74

if.end74:                                         ; preds = %if.end58, %do.end72
  %9 = load %struct.CUevent_st** @_Z7__start, align 8, !tbaa !1
...
if.end13:                                         ; preds = %do.end, %if.then10
  %5 = load %struct.CUmod_st** @_Z5__mod, align 8, !tbaa !1
  %tobool14 = icmp eq %struct.CUmod_st* %5, null
  br i1 %tobool14, label %if.end32, label %do.body16

do.body16:                                        ; preds = %if.end13
  %call17 = tail call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8]* @.str18, i64 0, i64 0))
  %6 = load %struct.CUmod_st** @_Z5__mod, align 8, !tbaa !1
...
if.then23:                                        ; preds = %do.body16
  %call24 = tail call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([35 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([15 x i8]* @.str18, i64 0, i64 0), i32 %call19)
  br label %if.end25
...
do.body35:                                        ; preds = %if.end32
  %call36 = tail call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8]* @.str19, i64 0, i64 0))
...
if.then42:                                        ; preds = %do.body35
  %call43 = tail call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([35 x i8]* @.str5, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8]* @.str19, i64 0, i64 0), i32 %call38)
  br label %if.end44
...
if.then6.i:                                       ; preds = %if.end
  call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([5 x i8]* @.str30, i64 0, i64 0))
  ...
  %.pre71 = load i32* %elem_size.i, align 4, !tbaa !11
...
; Function Attrs: nounwind
declare i32 @snprintf(i8* nocapture, i64, i8* nocapture readonly, ...) #4
...
_Z10__buf_sizePvP8buffer_t.exit:                  ; preds = %if.end5, %if.then6.i
  ...
  %15 = load i8** %host, align 8, !tbaa !18
...
do.body:                                          ; preds = %_Z10__buf_sizePvP8buffer_t.exit, %if.then10
  ...
  %17 = load i8** %host, align 8, !tbaa !18
...
entry:
  ...
  %2 = getelementptr inbounds [256 x i8]* %msg.i, i64 0, i64 0
  call void @llvm.lifetime.start(i64 256, i8* %2) #3
  %call.i = call i64 @halide_current_time_ns(i8* %user_context)
  %call1.i = call i32 (i8*, i64, i8*, ...)* @snprintf(i8* %2, i64 256, i8* getelementptr inbounds ([23 x i8]* @.str29, i64 0, i64 0), i8* %entry_name, i64 %call.i)
  %3 = load %struct.CUevent_st** @_Z7__start, align 8, !tbaa !1
  %call2.i = call i32 @cuEventRecord(%struct.CUevent_st* %3, %struct.CUstream_st* null)
  %call5.i = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i8* %2)
  %4 = load %struct.CUmod_st** @_Z5__mod, align 8, !tbaa !1
...
if.then.i:                                        ; preds = %entry
  %call8.i = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([35 x i8]* @.str5, i64 0, i64 0), i8* %2, i32 %call6.i)
  call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([23 x i8]* @.str6, i64 0, i64 0))
...
_Z12__get_kernelPvPKc.exit:                       ; preds = %entry, %if.then.i
  ...
  %call2 = call i32 (i8*, i64, i8*, ...)* @snprintf(i8* %11, i64 256, i8* getelementptr inbounds ([71 x i8]* @.str28, i64 0, i64 0), i8* %entry_name, i32 %blocksX, i32 %blocksY, i32 %blocksZ, i32 %threadsX, i32 %threadsY, i32 %threadsZ, i32 %shared_mem_bytes, i64 %call1)
  ...
  %call6 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([7 x i8]* @.str3, i64 0, i64 0), i8* %11)
...
if.then:                                          ; preds = %_Z12__get_kernelPvPKc.exit
  %call9 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([35 x i8]* @.str5, i64 0, i64 0), i8* %11, i32 %call7)
  call void @halide_error(i8* %user_context, i8* getelementptr inbounds ([23 x i8]* @.str6, i64 0, i64 0))
  br label %do.end
...
do.end:                                           ; preds = %_Z12__get_kernelPvPKc.exit, %if.then
  ...
  %call17 = call i32 (i8*, i8*, ...)* @halide_printf(i8* %user_context, i8* getelementptr inbounds ([24 x i8]* @.str22, i64 0, i64 0), double %conv, i64 %call16)
