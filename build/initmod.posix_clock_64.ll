; ModuleID = 'src/runtime/posix_clock.cpp'
...
entry:
  ...
  %2 = load i64* %tv_usec, align 8, !tbaa !9
  %3 = load i64* getelementptr inbounds (%struct.timeval* @halide_reference_clock, i64 0, i32 1), align 8, !tbaa !9
  %sub1 = sub i64 %2, %3
