...
@llvm.used = appending global [25 x i8*] [i8* bitcast (double ()* @minval_f64 to i8*), i8* bitcast (i64 ()* @maxval_s64 to i8*), i8* bitcast (double ()* @maxval_f64 to i8*), i8* bitcast (i8 ()* @maxval_s8 to i8*), i8* bitcast (i8 ()* @maxval_u8 to i8*), i8* bitcast (float ()* @inf_f32 to i8*), i8* bitcast (float ()* @nan_f32 to i8*), i8* bitcast (float ()* @minval_f32 to i8*), i8* bitcast (double (i64)* @double_from_bits to i8*), i8* bitcast (i16 ()* @minval_u16 to i8*), i8* bitcast (i8 ()* @minval_s8 to i8*), i8* bitcast (i32 ()* @maxval_u32 to i8*), i8* bitcast (i64 ()* @minval_s64 to i8*), i8* bitcast (i32 ()* @minval_u32 to i8*), i8* bitcast (i16 ()* @minval_s16 to i8*), i8* bitcast (i8 ()* @minval_u8 to i8*), i8* bitcast (i16 ()* @maxval_u16 to i8*), i8* bitcast (float (i32)* @float_from_bits to i8*), i8* bitcast (float ()* @maxval_f32 to i8*), i8* bitcast (i64 ()* @minval_u64 to i8*), i8* bitcast (i32 ()* @minval_s32 to i8*), i8* bitcast (float ()* @neg_inf_f32 to i8*), i8* bitcast (i64 ()* @maxval_u64 to i8*), i8* bitcast (i32 ()* @maxval_s32 to i8*), i8* bitcast (i16 ()* @maxval_s16 to i8*)], section "llvm.metadata"
