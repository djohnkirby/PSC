...
@halide_random_state_pool = weak global [256 x i32] zeroinitializer, align 16
...
entry:
  ...
  call void @llvm.memset.p0i8.i64(i8* bitcast ([256 x i32]* @halide_random_state_pool to i8*), i8 0, i64 1024, i32 16, i1 false)
...
entry:
  ...
  %arrayidx = getelementptr inbounds [256 x i32]* @halide_random_state_pool, i64 0, i64 %idxprom
