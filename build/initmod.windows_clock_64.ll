...
if.then:                                          ; preds = %entry
  %call = tail call zeroext i1 @QueryPerformanceCounter(i64* @halide_reference_clock)
  %call1 = tail call zeroext i1 @QueryPerformanceFrequency(i64* @halide_clock_frequency)
...
declare zeroext i1 @QueryPerformanceCounter(i64*) #1

declare zeroext i1 @QueryPerformanceFrequency(i64*) #1

; Function Attrs: uwtable
define weak i64 @halide_current_time_ns(i8* %user_context) #0 {
entry:
  %clock = alloca i64, align 8
  %call = call zeroext i1 @QueryPerformanceCounter(i64* %clock)
