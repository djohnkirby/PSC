...
entry:
  ...
  %add.ptr = getelementptr inbounds i8* %call, i32 32
  %args1 = bitcast i8** %args to i8*
  call void @llvm.va_start(i8* %args1)
  %0 = load i8** %args, align 4, !tbaa !1
  %call2 = call i32 @vfprintf(i8* %add.ptr, i8* %fmt, i8* %0)
  call void @llvm.va_end(i8* %args1)
  ret i32 %call2
}

declare i8* @__iob_func() #0
...
define weak i32 @snprintf(i8* %user_context, i8* %str, i32 %size, i8* %fmt, ...) #0 {
entry:
  %args = alloca i8*, align 4
  %args1 = bitcast i8** %args to i8*
  call void @llvm.va_start(i8* %args1)
  %0 = load i8** %args, align 4, !tbaa !1
  %call = call i32 @_vsnprintf(i8* %str, i32 %size, i8* %fmt, i8* %0)
  call void @llvm.va_end(i8* %args1)
  ret i32 %call
}

declare i32 @_vsnprintf(i8*, i32, i8*, i8*) #0
